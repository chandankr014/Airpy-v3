...
#     df = pd.read_csv("data\After_Cleaning\site_5112_2022.csv")
#     df = calculate_gvaqi(df)
#     df[['dates', 'NO2_CPCB', 'PM10_clean','PM25_clean', 'Ozone_clean', 'NO2_sub_index', 'PM10_sub_index', 'PM25_sub_index', 'O3_sub_index', 'AQI', 'Index_pollutant']] #[df['AQI'] > 0][300:310]
#     df.to_csv("aqi_calculator_output.csv")
